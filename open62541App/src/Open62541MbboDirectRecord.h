...
#ifndef OPEN62541_EPICS_MBBO_DIRECT_RECORD_H
#define OPEN62541_EPICS_MBBO_DIRECT_RECORD_H
 ...
 */
class Open62541MbboDirectRecord: public Open62541OutputRecord<::mbboDirectRecord> {
...
public:
   ...
   */
  Open62541MbboDirectRecord(::mbboDirectRecord *record) :
...
private:
  ...
  Open62541MbboDirectRecord(const Open62541MbboDirectRecord &) = delete;
  Open62541MbboDirectRecord(Open62541MbboDirectRecord &&) = delete;
  Open62541MbboDirectRecord &operator=(const Open62541MbboDirectRecord &) = delete;
  Open62541MbboDirectRecord &operator=(Open62541MbboDirectRecord &&) = delete;
...
#endif // OPEN62541_EPICS_MBBO_DIRECT_RECORD_H
