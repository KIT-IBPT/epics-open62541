...
#ifndef OPEN62541_EPICS_BO_RECORD_H
#define OPEN62541_EPICS_BO_RECORD_H
 ...
 */
class Open62541BoRecord: public Open62541OutputRecord<::boRecord> {
...
public:
   ...
   */
  Open62541BoRecord(::boRecord *record) :
...
private:
  ...
  Open62541BoRecord(const Open62541BoRecord &) = delete;
  Open62541BoRecord(Open62541BoRecord &&) = delete;
  Open62541BoRecord &operator=(const Open62541BoRecord &) = delete;
  Open62541BoRecord &operator=(Open62541BoRecord &&) = delete;
...
#endif // OPEN62541_EPICS_BO_RECORD_H
