...
#ifndef OPEN62541_EPICS_STRINGOUT_RECORD_H
#define OPEN62541_EPICS_STRINGOUT_RECORD_H
...
/**
 * Device support class for the stringout record.
 */
class Open62541StringoutRecord: public Open62541OutputRecord<::stringoutRecord> {
...
public:
   ...
   */
  Open62541StringoutRecord(::stringoutRecord *record) :
...
protected:
  ...
  UaVariant readRecordValue() {
    ...
    // is a string (probably the most frequent case for stringout records).
    if (dataType == Open62541RecordAddress::DataType::unspecified) {
      dataType = Open62541RecordAddress::DataType::string;
    }
    // The stringout record ensures that strings are always null-terminated.
    ...
    case Open62541RecordAddress::DataType::string: {
      ...
      valueItem.length = std::strlen(valField);
  ...
  virtual void validateRecordAddress() {
    Open62541OutputRecord<::stringoutRecord>::validateRecordAddress();
...
private:
  ...
  Open62541StringoutRecord(const Open62541StringoutRecord &) = delete;
  Open62541StringoutRecord(Open62541StringoutRecord &&) = delete;
  Open62541StringoutRecord &operator=(const Open62541StringoutRecord &) = delete;
  Open62541StringoutRecord &operator=(Open62541StringoutRecord &&) = delete;
...
#endif // OPEN62541_EPICS_STRINGOUT_RECORD_H
